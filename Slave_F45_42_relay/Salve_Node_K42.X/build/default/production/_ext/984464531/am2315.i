...
int I2C2_MasterEnableRestart(void);
int I2C2_MasterStart(void);
int I2C2_MasterStop(void);
int I2C2_MasterSendAck(void);
int I2C2_MasterSendNack(void);
void I2C2_MasterStartRx(void);
unsigned char I2C2_MasterGetRxData(void);
int I2C2_MasterSendTxData(unsigned char data);
unsigned short crc16(unsigned char *ptr, unsigned char len);
unsigned short make_16(unsigned char high, unsigned char low);
void read_AM2315(void);
void read_SHT20(void);
# 10 "../modbus/am2315.c" 2
...
# 52 "../modbus/../Salve_Node_K42.X/mcc_generated_files/mcc.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdbool.h" 1 3
# 53 "../modbus/../Salve_Node_K42.X/mcc_generated_files/mcc.h" 2
...
# 56 "../modbus/../Salve_Node_K42.X/mcc_generated_files/mcc.h" 2

# 1 "../modbus/../Salve_Node_K42.X/mcc_generated_files/uart1.h" 1
# 57 "../modbus/../Salve_Node_K42.X/mcc_generated_files/uart1.h"
...
# 57 "../modbus/../Salve_Node_K42.X/mcc_generated_files/uart1.h" 2
...
# 57 "../modbus/../Salve_Node_K42.X/mcc_generated_files/mcc.h" 2
...
# 11 "../modbus/am2315.c" 2



# 1 "../modbus/i2c2_master.h" 1
# 58 "../modbus/i2c2_master.h"
typedef enum {
    I2C2_NOERR,
    I2C2_BUSY,
    I2C2_FAIL
...
int16_t i2c1_read2ByteRegisterInt_16(uint8_t address, uint8_t reg);
void i2c1_write1ByteRegister(uint8_t address, uint8_t reg, uint8_t data);
static __attribute__((inline)) void wait4Stop(void);
# 14 "../modbus/am2315.c" 2

char buf_test[30];
extern volatile unsigned short sensor_timer1_ms = 0;
uint8_t sum_error_am2315;
uint32_t time_out_i2c;
uint16_t tick_out_i2c;
uint8_t sum_error_i2c;

unsigned short checkCRC(uint16_t message_from_sensor, uint8_t check_value_from_sensor) {
    int i;
...
void I2C2_Master_Reset_Bus(void) {
...
int I2C_Master_Wait_Read_Ready(void) {
    unsigned short t = 0;
    while (1) {

        if (I2C2CON0bits.MDR == 1) {
            UART2_Write_String("\r\n  read");
            break;
...
int I2C2_MasterStart_Read(void) {
    uint32_t t = 0;
    I2C2CON0bits.RSEN = 1;
    I2C2CON0bits.S = 1;
    __asm(" clrwdt");
...
unsigned short make_16(unsigned char high, unsigned char low) {
    ...
    value = (((unsigned short) high << 8)&0xFF00) + low;
    return value;
}
