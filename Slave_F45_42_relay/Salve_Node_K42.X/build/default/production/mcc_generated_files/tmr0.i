...
volatile unsigned long tick_time1 = 0;
volatile unsigned short sensor_timer1_ms = 0;
...
void TMR0_CallBack(void)
{
    ...
    timer_modbus++;LATAbits.LATA5 ^= 1;
    if (timer_modbus == 100) {timer_modbus=0; LATAbits.LATA4 ^= 1;}
